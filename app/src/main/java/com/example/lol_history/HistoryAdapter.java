...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    private int[] itemId = {R.id.iv_item_0, R.id.iv_item_1, R.id.iv_item_2, R.id.iv_item_3, R.id.iv_item_4, R.id.iv_item_5, R.id.iv_item_6};
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            gameType = itemView.findViewById(R.id.tv_queue_type);
    ...
    private int getPlayerIndex(MatchHistory matchHistory) {
        int i = 0;
        for (MatchHistory.ParticipantIdentities participantsIdentities : matchHistory.getParticipantsIdentities()) {
    ...
    private String getRuneImageURL(MatchHistory matchHistory, int playerIndex, int runeIndex) {
        ...
        String icon = parser.getRuneIconURL(runeId);
